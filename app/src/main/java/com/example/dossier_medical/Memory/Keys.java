...
public class Keys {
    ...
    public static class PreferencesKeys {
        ...
        public static final String USER_NUM_ORDRE = "USER_NUM_ORDRE";
        ...
        public static final String STORE_NAME_ENTITE= "STORE_NAME_ENTITE";

        public static final String LOAD_DATA_FIRST = "LOAD_DATA_FIRST";
        public static final String REGISTER = "REGISTER";
        public static final String FIRST_CONNECT = "FIRST_CONNECT";
        public static final String STORE_ENTREPRISE__ID= "STORE_ENTREPRISE__ID";
