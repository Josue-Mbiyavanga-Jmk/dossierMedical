...
public class FragStoryVisite extends Fragment implements RecyclerAdapterMalade.ItemButtonListener {
    ...
    public FragStoryVisite() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static FragStoryVisite newInstance() {
        FragStoryVisite fragment = new FragStoryVisite();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.frag_story_visite, container, false);
