...
public class FragMaladeList extends Fragment implements RecyclerAdapterMalade.ItemButtonListener {
    ...
    public FragMaladeList() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static FragMaladeList newInstance() {
        FragMaladeList fragment = new FragMaladeList();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.frag_list_malade_item, container, false);
