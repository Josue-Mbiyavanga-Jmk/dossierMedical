...
public class RecyclerAdapterMenuMalade extends RecyclerView.Adapter<RecyclerAdapterMenuMalade.ViewHolder> {
    private List<ActivityMenuMalade.Menu> items;
    ...
    public RecyclerAdapterMenuMalade(AppCompatActivity appCompatActivity, List<ActivityMenuMalade.Menu> items, ItemButtonListener callback) {
        this.items = items;
    ...
    @Override
    public RecyclerAdapterMenuMalade.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.items_menu_malade, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final ActivityMenuMalade.Menu item =items !=null ? items.get(position):null;


        if(item!=null)
        {
            holder.txt_name.setText(item.getName());
            holder.menuImage_Id.setImageDrawable(item.getPhoto());
...
//        items.addAll(list_items);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyTextView_Roboto_Regular txt_name;
        public ImageView menuImage_Id;
        ...
        public ViewHolder(View v) {
            ...
            menuImage_Id = v.findViewById(R.id.menuImage_Id);
