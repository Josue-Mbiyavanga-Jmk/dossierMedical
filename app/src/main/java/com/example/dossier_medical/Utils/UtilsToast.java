...
public class UtilsToast {
    ...
    public  static void showCFAlertDialogFrag(Fragment activity, String title, String message, ETypeMessage typeMessage)
    {
        switch (typeMessage)
        {
            case ERROR:
                CFAlertDialog.Builder builder = new CFAlertDialog.Builder(activity.getContext())
                        .setDialogStyle(CFAlertDialog.CFAlertStyle.BOTTOM_SHEET)
                        .setTitle(title)
                        .setCancelable(false)
                        .setMessage(message)
            ...
            case SUCCES:
                ...
                CFAlertDialog.Builder builder_positive = new CFAlertDialog.Builder(activity.getContext())
                        .setDialogStyle(CFAlertDialog.CFAlertStyle.BOTTOM_SHEET)
                        .setTitle(title)
                        .setCancelable(false)
                        .setMessage(message)
