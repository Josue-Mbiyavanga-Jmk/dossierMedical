...
public class ActivityMaladeExamen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malade_examen);
    ...
    private class MyPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int pos) {
            switch (pos) {
                case 0: {
                    return new FragActionExamen();
                }
                case 1: {

                    return new FragStoryExamen();
                }
