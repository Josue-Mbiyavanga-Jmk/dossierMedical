...
import com.example.dossier_medical.Fragments.FragActionTension;
import com.example.dossier_medical.Fragments.FragActionVaccin;
import com.example.dossier_medical.Fragments.FragStoryTension;
import com.example.dossier_medical.Fragments.FragStoryVaccin;
import com.example.dossier_medical.R;
import com.google.android.material.tabs.TabLayout;
import com.google.android.material.tabs.TabLayoutMediator;

public class ActivityMaladeTension extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malade_tension);
    ...
    private class MyPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int pos) {
            switch (pos) {
                case 0: {
                    return new FragActionTension(eMalade);
                }
                case 1: {

                    return new FragStoryTension(eMalade);
                }
