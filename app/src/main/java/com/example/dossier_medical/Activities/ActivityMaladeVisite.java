...
import com.example.dossier_medical.Fragments.FragActionVisite;
import com.example.dossier_medical.Fragments.FragStoryVisite;
import com.example.dossier_medical.R;
import com.google.android.material.tabs.TabLayout;
import com.google.android.material.tabs.TabLayoutMediator;

public class ActivityMaladeVisite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malade_visite);
    ...
    private class MyPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int pos) {
            switch (pos) {
                case 0: {
                    return new FragActionVisite();
                }
                case 1: {

                    return new FragStoryVisite();
                }
