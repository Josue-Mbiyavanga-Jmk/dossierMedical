...
import com.example.dossier_medical.Fragments.FragActionGlycemie;
import com.example.dossier_medical.Fragments.FragStoryExamen;
import com.example.dossier_medical.Fragments.FragStoryGlycemie;
import com.example.dossier_medical.R;
import com.google.android.material.tabs.TabLayout;
import com.google.android.material.tabs.TabLayoutMediator;

public class ActivityMaladeGlycemie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malade_glycemie);
    ...
    private class MyPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int pos) {
            switch (pos) {
                case 0: {
                    return new FragActionGlycemie(eMalade);
                }
                case 1: {

                    return new FragStoryGlycemie(eMalade);
                }
