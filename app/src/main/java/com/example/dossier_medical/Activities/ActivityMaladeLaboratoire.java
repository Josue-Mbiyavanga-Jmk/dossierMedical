...
import com.example.dossier_medical.Fragments.FragActionExamen;
import com.example.dossier_medical.Fragments.FragActionLaboratoire;
import com.example.dossier_medical.Fragments.FragStoryExamen;
import com.example.dossier_medical.Fragments.FragStoryLaboratoire;
import com.example.dossier_medical.R;
import com.google.android.material.tabs.TabLayout;
import com.google.android.material.tabs.TabLayoutMediator;

public class ActivityMaladeLaboratoire extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malade_laboratoire);
    ...
    private class MyPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int pos) {
            switch (pos) {
                case 0: {
                    return new FragActionLaboratoire();
                }
                case 1: {

                    return new FragStoryLaboratoire();
                }
